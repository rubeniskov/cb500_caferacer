...
#define ECU_SENSOR_PRESURE_MIN_VREF_VALUE ((uint32_t)330)  // 0.333 Volts
#define ECU_SENSOR_PRESURE_MAX_VREF_VALUE ((uint32_t)2970) // 2.97 Volts
#define ECU_SENSOR_PRESURE_MIN_UNIT_VALUE 0
#define ECU_SENSOR_PRESURE_MAX_UNIT_VALUE 200
...
/**
  * @brief  ECU Sensor Kind structures definition
  */
typedef enum
{
  ECU_SENSOR_PRESURE                  = (uint8_t)0x1,
  ECU_SENSOR_TEMPERATURE               = (uint8_t)0x2,
  ECU_SENSOR_VOLUME                    = (uint8_t)0x3
} ECU_SensorKindTypeDef;

/**
  * @brief  ECU Sensor Id structures definition
  */
typedef enum
{
  ECU_SENSOR_PRESURE_COOLANT           = ECU_SENSOR_TYPE_MASK(ECU_SENSOR_PRESURE, 0x1),
  ECU_SENSOR_PRESURE_OIL               = ECU_SENSOR_TYPE_MASK(ECU_SENSOR_PRESURE, 0x2),
